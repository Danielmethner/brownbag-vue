...
const POS_LOAN_GET_BY_PARTY_ID = '/api/pos/financing/party/';
...
class PosService {
  ...
  getPosLoanByPartyId(partyId) {
    return axios
      .get(GLOBAL.API_BASE_URL + POS_LOAN_GET_BY_PARTY_ID + partyId, { headers: jsonHeader() });
  }
